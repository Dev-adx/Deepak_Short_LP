...
const AboutCoach = () => (
  <section className="py-16 px-4 bg-muted/50">
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 bg-card rounded-2xl border p-8">
        <img
          src={coachImg}
        ...
        <div className="space-y-3 text-center md:text-left">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Trusted coach with <strong className="text-foreground">10 Cr+ market exposure</strong> and 5+ years of experience
